      ...
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mb-4">
            ...
            <select
              id="category"
              className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 ${errors.category ? "border-red-500" : ""}`}
          ...
          <div className="mb-4">
            ...
            <input
              type="number"
              id="amount"
              className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 ${errors.amount ? "border-red-500" : ""}`}
              {...register("amount", { required: "Amount is required", min: { value: 0, message: "Amount must be a positive number" }})}
              step="0.01"
            />
          ...
          <div className="mb-4">
            ...
            <input
              type="date"
              id="date"
              className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 ${errors.date ? "border-red-500" : ""}`}
